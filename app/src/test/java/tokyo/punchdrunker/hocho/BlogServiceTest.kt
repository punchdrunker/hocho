...
class BlogServiceTest {
    ...
    fun fetchFeed() {
        ...
        actual.body()!!.entryList!!.run {
            ...
            assertEquals(
                "Posted by Alicja Heisig, Developer Relations Program Manager   Welcome to #IamaGDE - a series of spotlights presenting Google Developer Expe...",
                this[0].shortContent()
            )
            assertEquals(
                "https://blogger.googleusercontent.com/img/a/AVvXsEgHl1OMxu_r7B6C2OHY0OsAyNn8j00v_A2ASjMKfjrw2JO0B9fbD6-5uohhucBeSLh_6ngRqhyARan_Tn1Sd-veSxOc3b-Lo1H_Q0PktyH5hrpCkhX54T8PoLWqFlfkRWIIy_0GWkK84s1CgfSk8w05GanB28I5mnb4vDPrHqG0CBmkcNuiqNygPjgP",
                this[0].imageUrl()
            )
        }
    }
